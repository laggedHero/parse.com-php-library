...
class parseQueryTest extends \Enhance\TestFixture {
	...
	public function setUp(){
		...
		$this->parseQuery = \Enhance\Core::getCodeCoverageWrapper('Parse\Query', array('test'));
		$this->parseQueryUser = \Enhance\Core::getCodeCoverageWrapper('Parse\Query', array('users'));
